...
\textbf{weak lines ($< 200$ m\AA)} in the Fe line list of \textbf{\citet{Sousa-2008}.} 
\textbf{ This list is comprised of 263 Fe[I] and 36 Fe[II] stable lines, ranging, in wavelength, from 4500 to 6890 \AA}. 
\textbf{Then, we} followed the procedure described in \citet{Santos-2004b}: 
...
\citet{Upgren-1974}; [HIP] \citet{van_Leeuwen-2007}; [W81]
...
0 and 2 therefore has little impact on the outcome. \textbf{We
...
\textbf{The $M_{K}$ from the B05 calibration is the absolute magnitude
...
of \citet{Delfosse-2000}. In the JA09 calibration, the $\Delta (V-K)$ is the difference between 
...
the two estimates for the sample. Table \ref{tablefehfeh} displays the metallicity values from
...
SL10 : $[Fe/H] = 0.79\Delta (V-K) - 0.17, \Delta (V-K) = (V-K)_{obs} - (V-K)_{iso}$ & $0.02\pm0.04$ & $0.19\pm0.03$ & $0.03\pm0.01$ & $0.42\pm0.28$ \\
...
We also measure an offset of $0.02\pm0.04$~dex. Offset and rms are
