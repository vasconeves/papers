...
that we transform into K$_{S}$ photometry using the equations of \citet{Carpenter-2001}. 
...
The upper panel of Fig. \ref{fehcalib} depicts the different [Fe/H] calibrations from \citet{Bonfils-2005}
...
in a $\{(V-K)-M_{K_{s}}\}$ color-magnitude diagram into a useful metallicity
...
representative of average M dwarfs in the $\{(V-K)-M_{K_{s}}\}$ 
color-magnitude diagram, and used the distance to that main sequence 
along $M_{K_{s}}$ as a metallicity diagnostic. They noted that the
