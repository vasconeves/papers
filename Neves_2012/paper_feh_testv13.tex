...
\subtitle{II. A comparative study of photometric metallicity scales\thanks{Based on observations collected with the FEROS, ELODIE and SOPHIE spectrographs under the programs 060.A-9120(B), 073.D-0802(A), 074.D-0670(A), respectively.}}
%\subtitle{}
...
%We present a comparative test of several photometric metallicity calibrations of M dwarfs proposed in the literature. Our test sample is made of 23 M dwarfs, companion of widely separated ($>$ 5 arcsec) F-, G- or K- dwarfs with known or newly measured uniform metallicities. We include M dwarfs with reliable V photometry by restricting our sample to stars with V uncertainty lower than $\sim$0.03 dex. Among all calibrations, we find that the one of Schlaufman \& Laughlin (2010) provides lower offset and residuals against our sample and, ultimately, we used our larger sample to update and marginally improve their calibration. Despite better V photometry than used in previous studies, the dispersion remains largely in excess given the [Fe/H] and photometric uncertainties. This suggests the remaining dispersion has physical rather than experimental roots.
...
persist for Neptune-mass planets around M dwarfs. \textcolor{red}{[ref]}

%From the ever growing number of exoplanets, interesting statistical properties emerge from their characteristics or the characteristics of their host stars {\color{red} \citep[e.g.][Bonfils et al. 2011 in prep.]{Endl-2006,Johnson-2007,Udry-2007}}. Among those, the planet-metallicity correlation is one of the most remarkable: stars with higher metal content have, on average, a higher probability to host Jovian planets \citep{Gonzalez-1997, Santos-2001a, Santos-2004b, Fischer-2005}. Within the core-accretion paradigm of the planetary formation, that property is expected to extend to the cooler M dwarfs: to counterbalance the lower mass of their protoplanetary disks, and provide enough material to form a planet of similar mass, their density has to increase. And, while the planet-metallicity correlation seems to vanish for FGK stars that host Neptunes and lower-mass planets \citep{Sousa-2008, Bouchy-2009}, it might remain persistent for M dwarfs that host Neptune-mass planet \textcolor{blue}{[ref]}.
...
single parent distribution \citep{Bonfils-2007}. {\em \color{red} we probably
...
%Probing the planet-metallicity correlation for M dwarfs has largely motivated the first metallicity calibration \citep{Bonfils-2005}, but only two M-dwarf hosts were known at the time. A few more planet detections later on allowed the comparison of the metallicity distributions of M dwarfs {\it with} and {\it without} known planets, and a {\bf Kolmogorov-Smirnov test indicates that they have a $\sim11\%$ probability that they belong to the same parent distribution \citep{Bonfils-2007}} {\em we probably need to cite Johnson here.}. Today, even after more planets have been detected, and the calibration improved, the probability that M-dwarf hosts are more metal rich than the common M dwarf is evaluated to be $\sim6\%$ \citep{Schlaufman-2010}. Although this result lines with the core accretion paradigm, the confidence level of that difference remains below 3 $\sigma$. Multiplying the number of known planets and improving metallicity determinations further are therefore the two avenues that must be pursued to better measure the correlation between the stellar metallicity and the planet occurrence for M dwarfs.
...
%with spectral subtype, their forest of weak lines eventually erases
%the spectral continuum, and makes a line-by-line spectroscopic
%analysis {\bf more difficult for all but the earlier M subtypes. Although the revised oxygen solar abundance \citep{Asplund-2009,Caffau-2011} resolved a long lasting issue for model atmospheres of M dwarfs \citep{Allard-2010}, many visual to red spectral features correspond to incomplete or missing opacities in the models}. 
%%Atmospheric models imperfectly reproduce the details of these complex spectral features, in large part because they have to rely on incomplete and imprecise molecular opacity databases. 
%Spectral synthesis, as well, has therefore had limited success in analysing M~dwarf
%spectra \citep[e.g.][]{Valenti-1998,Bean-2006}. In this context, several less direct techniques
%have been developed to measure the metal content of M dwarfs. Of those, the most successful is
...
%This approach was pioneered by \citet{Bonfils-2005}, who found out a modest significance disagreement between the mean metallicity of a volume-limited sample of early/mid-M dwarfs and the average metallicity of the solar-neighborhood FGK dwarfs. Later on, \citet{Johnson-2009} correctly pointed out that M and (at least) K dwarfs have the same age distribution, since both live longer than the age of the universe, and therefore should have the same metallicity distribution. They derived a different calibration (from largely the same data), by forcing agreement of the mean, removing the few spectroscopic metallicity of early or/and metal-poor M dwarfs used by \citet{Bonfils-2005}. The most recent calibration, published by \citet{Schlaufman-2010}, points out the importance of kinematically matching the M and GK samples before forcing identical mean metallicities, and use  the stellar structure models to guide their choice of a more effective parametrization of the position in the $M_{V}$ vs $V-K$ diagram. The difference between the 3 calibrations varies in detail with position in the color-absolute magnitude diagram but, on average, the \citet{Johnson-2009} calibration is 0.2 dex more metal-rich than \citet{Bonfils-2005}, and \citet{Schlaufman-2010} is half-way between those two extremes.
%}

%However, the measurement of the stellar parameters of M dwarfs from their spectra is not a trivial task. As the stellar subtype increases, the number of diatomic and triatomic molecules (e.g. TiO, VO, H$_{2}$O, CO, etc) in their atmospheres increases, effectively depressing the continuum and making a line-by-line spectroscopic analysis {\bf more difficult for all but the earlier subtypes. Although the revised oxygen solar abundance \citep{Asplund-2009,Caffau-2011} resolved a long lasting issue for model atmospheres of M dwarfs \citep{Allard-2010}, many visual to red spectral features correspond to incomplete or missing opacities in the models}. In this context, several techniques, more or less successful, have been employed to measure the metal content of M dwarfs \textcolor{blue}{[ref]}.
...
%We aim to test  recently published photometric calibrations of the M-dwarf metallicity. To that purpose, we have built a comparison sample of 23 M dwarfs with accurate photometry and parallaxes (Sect.~\ref{sample}). Then, we propose a test to compare different calibrations (Sect.~\ref{test}) and choose to review, compare and discuss three works on the subject (Sect.~\ref{latest}). Those works are \citet{Bonfils-2005}, \citet{Johnson-2009} and \citet{Schlaufman-2010}, and we refer to them as B05, JA09 and SL10, respectively. Actually, two expressions are proposed in B05, one that calibrates metallicity in a color-magnitude diagram, which is commonly used in the literature, and a second that calibrates metallicity as a function of a mass anomaly. We wish to have both expressions in our comparison list and refer to them as B05 and B05(2), respectively. We also sieze the opportunity of an increased sample to update the metallicity calibration of SL10 and thus add this fifth calibration to our list. Note that for completeness, we also consider the works of \citet{Casagrande-2008} and \citet{Rojas-Ayala-2010} but defer their description to an appendix, the former because it does not exactly qualify as a calibration (it requires input from an existing calibration and do not provide an expression), the later because it goes beyond the photometric calibrations of our paper by bringing metallicity scale to a higher spectral resolution. Finally, Sect.~\ref{discussion} presents our conclusions.
...
{\color{red} We note that the RIJH photometry was only needed to calculate 
metallicity values using the \citet{Casagrande-2008}
calibration, described in the Appendix. 
...
%We aim to test different calibrations and, much like most calibrations discussed in this paper, we make use of FGK$+$M binaries. The metal content is determined on the primaries with classical techniques and assumed to be the same for the secondaries. Our first step is therefore to build a sample of such binaries.
...
%{\color{red} Such selection described above lead to a sample of almost
%300 binaries. But only a small part of them has precise metallicity
%and parallax measurements for the primary, precise photometry for the
%secondary, and proper motions for the pair at the same time. For this
%paper we have obtained (from literature compilation and new
%observations) such accurate parameters for a sub-sample of 19
%M-dwarf secondaries that extend slightly to the K-dwarf domain with 4
%additional K7/K8 secondaries. 
%}
...
References. [B05] \citet{Bonfils-2005}; [COR] CCF [Fe/H] taken from spectra of the CORALIE Spectrograph; [S08CAL] T$_{eff}$ calibration from \citet{Sousa-2008}; [S08] \citet{Sousa-2008}; [NEW] This paper; [SPO] \citet{Valenti-2005}; [SOP] CCF [Fe/H] taken from spectra of the SOPHIE Spectrograph \citep{Bouchy-2006}.
...
parallaxes, photometry, and metallicity for the
full sample, along with their respective references. {\em \color{red} Also, we 
...
%{\color{green} The stellar parameters measured from the primaries are shown in Table \ref{parameters}. All the other parameters (parallaxes and photometry) along with their respective references are listed in Table \ref{estrelas} in the Appendix.}
...
The upper panel of Fig. \ref{fehpanel} depicts the different calibrations.
The lower panels show the difference between photometric 
and spectroscopic metallicities, as a function of the calibrated 
...
\subfigure[This paper]{\includegraphics[scale=0.35]{../gfx/poster_pics/new_cal.pdf}}
\end{center}
\caption{The tested photometric calibrations. From \citet{Bonfils-2005} (a and b), \citet{Johnson-2009} (c), and \citet{Schlaufman-2010} (d). The (e) panel depicts the update we did of the calibration of \citet{Schlaufman-2010} using the sample of this paper. The blue dots with error bars represent the data points. The metallicity difference between the values of the calibrations and the spectroscopic measurements is shown below each calibration. The black dashed line is the zero point of the difference, and the red dotted line represents the average of the metallicity difference.  }
\label{fehcalib}
\end{figure*}
...
%\end{center}
%\caption{[Fe/H] of the calibrations versus the spectroscopic metallicity. The tested calibrations are from \citet{Bonfils-2005} {\color{red} (a and b, based, respectively, on the $\{(V-K)-M_K\}$ color-magnitude diagram, and on the difference between the V- and K-band expressions of the mass-luminosity relation given in \citet{Delfosse-2000})}, \citet{Johnson-2009} (c), and \citet{Schlaufman-2010} (d). The (e) panel depicts the update we did of the calibration of \citet{Schlaufman-2010} using the sample of this paper. The blue dots with error bars represent the data points. The black line depicts a one to one relationship. The metallicity difference between the values of the calibrations and the spectroscopic measurements is shown below each [Fe/H]-[Fe/H] plot. The black dashed line is the zero point of the difference, and the red dotted line represents the average of the metallicity difference.  }
%\label{fehfeh}
%\end{figure*}
%
%\begin{table*}[]
...
\end{center}
\caption{Fe/H] of the calibrations versus the spectroscopic metallicity.The blue dots with error bars represent the data points. The black line depicts a one to one relationship.}
\label{fehpanel}
\end{figure*}

{\color{red} In this section we will discuss the latest metallicity calibrations. Fig. \ref{fehpanel} plot the [Fe/H] obtained from each calibration against the spectroscopic [Fe/H], with the black lines depicting a one to one relationship. We will follow Figs. \ref{fehcalib} and \ref{fehpanel} in this section to help us analyse and compare the different calibrations.}
...
The dispersion of the sample, seen in all the plots of Fig. \ref{fehcalib} is much higher than the uncertainties of the measurements. This means that we are not limited by measurement uncertainties. If this was not the case the points would be much closer to the identity line.

{\color{red} 
As can be seen in Fig. \ref{fehpanel}, the B05, B05(2), slightly underestimate, in general, the [Fe/H] spectroscopic value. On the other hand, the JA09 calibration clearly overestimates, in general, the metallicity value, except for higher [Fe/H] values.}

%We must note the apparent trend with spectroscopic [Fe/H], having a negative slope, in the lower panel of all calibrations presented in this paper. When we fit a straight line in [Fe/H] data with large dispersion, the stars that fall below the line are given a higher metallicity, whereas the stars that fall above the line are given a lower metallicity. Therefore, by construction, any calibration will underestimate the [Fe/H] of stars with higher spectroscopic metallicity, and overestimate the [Fe/H] of stars with lower spectroscopic metallicity. This effect is clearly seen in all lower panels of Fig. \ref{fehcalib}, that depict the difference between the calibrated and spectroscopic metallicities as a function of the spectroscopic [Fe/H]. We also plotted the metallicity difference as a function of the calibrated [Fe/H] and the trend does not appear.}

%The B05 and B05(2) calibrations seem to overestimate the metallicity for spectroscopic [Fe/H] $< -0.4$. Regarding higher metallicities, above 0.2 dex, only the calibrations of JA09 and SL10 seem to accurately predict the spectroscopic metallicities: all the other calibrations underestimate the [Fe/H] value. 
...
{\em \color{red} Here we should probably speculate on the possible 
...
Calibration Source + equation & offset & rms & RMS$_{P}$ & R$^{2}_{ap}$  \\
	&[dex] &[dex] & [dex] & \\ 
\hline
B05 : \scriptsize{$[Fe/H] = 0.196 - 1.527M_{K} + 0.091M_{K}^{2} + 1.886(V-K) - 0.142(V-K)^{2}$} & $-0.05\pm0.04$ & $0.20\pm0.02$ & $0.04\pm0.01$ & $0.32\pm0.22$ \\
B05(2) : \scriptsize{$[Fe/H] = -0.149 - 6.508\Delta M, \Delta M = Mass_{V} - Mass_{K}$} & $-0.05\pm0.04$ & $0.21\pm0.02$ & $0.05\pm0.01$ & $0.22\pm0.34$ \\
C08 : - & $-0.12\pm0.07$ & $0.32\pm0.06$ & $0.11\pm0.04$ & $-1.09\pm1.47$ \\
JA09 : \scriptsize{$[Fe/H] = 0.56\Delta M_{K} - 0.05, \Delta M_{K} = MS - M_{K}$} & $0.14\pm0.04$ & $0.24\pm0.04$ & $0.06\pm0.02$ & $0.06\pm0.49$ \\
SL10 : \scriptsize{$[Fe/H] = 0.79\Delta (V-K) - 0.17, \Delta (V-K) = (V-K)_{obs} - (V-K)_{fit}$} & $0.02\pm0.04$ & $0.19\pm0.03$ & $0.03\pm0.01$ & $0.42\pm0.28$ \\
This paper : \scriptsize{$[Fe/H] = 0.595\Delta (V-K) - 0.158$} & $0.00\pm0.04$ & $0.17\pm0.03$ & $0.03\pm0.01$ & $0.44\pm0.23$ \\
\hline
\end{tabular}
\end{center}
\end{table*}%
