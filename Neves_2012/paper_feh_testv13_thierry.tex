...
\subtitle{II. A comparative study of photometric metallicity
  ...
  060.A-9120(B), 073.D-0802(A), 074.D-0670(A), and with the
...
France.
\and
Departamento de F{\'i}sica e Astronomia, Faculdade de Ci{\^e}ncias,
...
\citet[][,\citeyear{Woolf-2006}]{Woolf-2005} measured atomic 
...
{\color{red} We note that the RIJH photometry was only used to calculate 
...
\caption[]{ \label{estrelas}Sample of wide binaries with a FGK primary
  ...
  primaries with their associated standard  errors. Columns 6 to 12
  contain the  V(RI)$_{C}$JHK$_{S}$ photometry and associated
  errors. Column 13 contains the bibliographic references for the 
  photometry. }
...
References. [W93] \citet{Weis-1993}; [B90] \citet{Bessell-1990}; [C84]
\citet{Caldwell-1984}; [S96] \citet{Sinachopoulos-1996}; [U74]
\citet{Upgren-1974}; [HIP] \citet{ESA-1997}; [W81]
\citet{Weistrop-1981}; [L89] \citet{Laing-1989}; [R04]
\citet{Reid-2004}; [D88] \citet{Dahn-1988};  [W77]
\citet{Weistrop-1977}; [W96] \citet{Weis-1996}; [K02]
\citet{Koen-2002}; [E79] - \citet{Eggen-1979} [D92] -
\citet{Dawson-1992}; [D82] \citet{Dahn-1982}; [P82]
\citet{Pesch-1982}; [E76] \citet{Eggen-1976}; [W88] \citet{Weis-1988};
      [R89] \citet{Ryan-1989}; [B91] \citet{Bessell-1991}; [2MASS]
      \citet{Skrutskie-2006}.
\end{sidewaystable*}
...
The upper panels of Fig. \ref{fehfeh} plot the [Fe/H] obtained 
...
and spectroscopic metallicities, as a function of photometric
...
the two estimates for the sample. Table \ref{stats} displays 
...
Table \ref{tablefehfeh} displays the metallicity values from
...
\end{center}
\caption{[Fe/H] predicted by each photometric calibration against 
  spectroscopic metallicity of the primary. 
  The photometric calibrations are from \citet{Bonfils-2005}
  (a and b), \citet{Johnson-2009} (c), and \citet{Schlaufman-2010}
  (d). Panel (e) corresponds to our minor update of the 
  \citet{Schlaufman-2010} calibration. In each panel, the blue
  dots with error bars represent the data points. The black line
  depicts a one to one relationship. The lower subpanels plot
  the residuals of the calibration as a function of the spectroscopic
  metallicity. The black dashed lines represent a null difference,
...
\caption{Average offset, rms, residual mean square
  ...
  and \citet{Schlaufman-2010} applied to our data. ``This paper''
  refers to our small update to the \citet{Schlaufman-2010} calibration.
  } 
\label{stats}
\scriptsize
\begin{center}
...
\caption{Spectroscopic metallicity of the primaries and 
  ...
  of \citet{Bonfils-2005}, \citet{Casagrande-2008},
  \citet{Johnson-2009}, and \citet{Schlaufman-2010}. ``This
  paper'' refers to our small update of
  the \citet{Schlaufman-2010} calibration.}
\label{tablefehfeh}
\begin{center}
...
guide us trhough that discussion. 
...
significance of 1.3~$\sigma$. 
{\em Vasco's text had both 1.3 sigma and 2.6 sigmas for the
  significance of the discrepancy; this definitely needs to be
  clarified before we submit,  and I cannot do that in the train}
...
For our sample, the B05 calibration is offset by $-0.05\pm0.04$ dex
...
this -0.05 offset almost eliminates the metallicity difference between 
...
the SPOCS sample \citep{Valenti-2005}. They defined a sequence 
...
with [Fe/H] $ =  - 0.22$ allowed at the 1~$\sigma$ level 
...
$+0.14\pm0.04$~dex offset and a dispersion of $0.23\pm0.04$.
...
for that sample, $0.09$ dex lower than adopted by JA09. Secondly, 
they use stellar evolution models to guide their parametrization 
...
$0.15\pm0.02$~dex, and indistinguishable from $0.14\pm0.02$~dex
...
We also measure $0.02\pm0.04$~dex. Offset and rms are
both significant improvements over either of the B05 and JA10 calibrations.
...
neighborhood from the SPOCS catalog. This expression is adopted
from \citet{Schlaufman-2010},  who adapted an $M_{k}$ vs
$(V-K_{s})$ formula from \citet{Johnson-2009}. \sout{It has the
following coefficients, in increasing order: $51.1413, -39.3756,
12.2862, - 1.83916, 0.134266,$ and $-0.00382023$.}
...
The R$^{2}_{ap}$ value are similar ($0.42\pm0.28$ vs $0.44\pm0.23$), 
...
sequence and they there for much longer than a Hubble time,
...
completely different technique, based on his previous study of 
...
metallicities starts by computing the effective temperature of the
...
analysed 17 M dwarfs secondaries with a FGK primary, that served also
...
offset of just 0.04~dex offset between our spectroscopic measurements 
