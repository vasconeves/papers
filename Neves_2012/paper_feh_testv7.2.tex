...
{ \color{red}
SL10 have initially reported a dispersion of 0.15 dex. But against our test sample, we measure a higher value of $0.19\pm0.02$. {\color{blue} Any idea where the difference comes from ?}
We also measure an offset of $0.02\pm0.03$ dex\sout{, the lowest value of all calibrations}. {\color{blue} This is not true if you consider the update.} Both offset and r.m.s improved over B05 and JA10 calibrations.
}
...
The internal uncertainties for the metallicity are reported as $\sim$ 0.2 dex and their total uncertainty is estimated to be between 0.2 and 0.3 dex. {\color{blue} ???}
