...
Our new calibration is based on the measurement of pseudo equivalent widths (EWs) of most lines/features in the red part of spectra from a sub-sample of the HARPS GTO M dwarf sample \citep{Bonfils-2013}. The EWs are then correlated with the reference photometric [Fe/H] and $T_{eff}$ scales from \citet{Neves-2012} and \citet{Casagrande-2008} respectively. This method achieves an increase in precision of both parameters whereas its accuracy is tied to the original calibrations. The methodology is detailed in Sect. \ref{sec:method}. 
...
\end{equation}
and $C^{T}$ is the transpose of $C$. The refit is then expressed as
...
\end{center}
\caption{Difference of the [Fe/H] as a function of the resolution and SNR.}
\label{fig:resnr-feh}
\end{figure*}
...
\end{center}
\caption{Difference of the $T_{eff}$ as a function of the resolution and SNR.}
...
\begin{equation}
T_{eff} = T_{eff,B12}1.079\pm0.143 - 404.886\pm509.449,
\end{equation}
for RA12,
\begin{equation}
T_{eff} = T_{eff,RA12}0.731\pm0.176 + 713.804\pm616.858,
\end{equation}
and for R13,
\begin{equation}
T_{eff} = T_{eff,R13}1.103\pm0.156 - 542.267\pm,
\end{equation}
